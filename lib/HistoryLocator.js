...
})(this, function (module, babelHelpers, Locator, Location, _require, _require2) {
    'use strict';
        ...
        HistoryLocator.prototype.getLocation = function getLocation(e) {
            ...
            if (!id) {
                ...
                if (HISTORY_API_SUPPORTED) {
                    ...
                    window.history.replaceState(babelHelpers['extends']({}, state, (_babelHelpers$extends = {}, _babelHelpers$extends[HISTORY_LOCATOR_STATE_ID_KEY] = id, _babelHelpers$extends)), null, path);
                }
            }
...
//# sourceMappingURL=HistoryLocator.js.map
