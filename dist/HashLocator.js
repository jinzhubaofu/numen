...
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', './util', './Locator', './Location', './action'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require('./util'), require('./Locator'), require('./Location'), require('./action'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, global.util, global.Locator, global.Location, global.action);
        global.HashLocator = mod.exports;
    }
})(this, function (module, util, Locator, Location, action) {
    'use strict';
